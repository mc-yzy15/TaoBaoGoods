...
2. 将解压后的文件夹重命名为`chromedriver`，并移动到`C:\Program Files\`目录下
3. 打开系统环境变量，找到PATH，添加`C:\Program Files\chromedriver`，并确定应用
4. 验证是否安装成功：打开powershell，输入`chromedriver --version`，如果返回版本号，则安装成功
